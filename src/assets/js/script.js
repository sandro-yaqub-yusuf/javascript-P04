document.querySelector('.busca').addEventListener('submit', async (event) => {
    event.preventDefault(); // Para desativar o SUBMIT automático do formulário
    ...
    if (input !== '') {
        ...
        showWarning('Aguarde... Carregando as informações de clima e tempo...');
        ...
        if (json.cod === 200) {
            ...
            showWarning('Esta localidade não foi encontrada...');
        }
    }
    else {
        clearInfo();
