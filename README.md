...
* Informações extras: Necessita conhecimentos médios em Javascript. Este projeto não utiliza qualquer meio de gravação de dados em disco. Também será necessário se cadastrar no site da OPEN WEATHER para poder obter a API KEY que será enviada na chamada da API.
